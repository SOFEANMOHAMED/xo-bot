...
const FACEBOOK_OAUTH_ERROR_MESSAGES: Record<string, string> = {
  no_pages:
    'لم يُعثر على صفحات فيسبوك بعد التفويض. على الهاتف: أثناء شاشة صلاحيات ميتا اختر النشاط التجاري ثم فعّل الصفحة المطلوبة واضغط متابعة/حفظ — لا تتخطَّ خطوة اختيار الصفحات.',
  business_pages:
    'صفحتك مرتبطة بـ Meta Business Suite. أثناء التفويض وافق على صلاحية إدارة الأعمال (business management) واختر النشاط والصفحة معاً، ثم أعد المحاولة.',
  oauth_failed:
...
const INSTAGRAM_OAUTH_ERROR_MESSAGES: Record<string, string> = {
  ...
  no_pages:
    'لم يُعثر على صفحات فيسبوك بعد التفويض. على الهاتف: اختر النشاط التجاري ثم الصفحة المرتبطة بإنستغرام أثناء شاشة ميتا، ولا تتخطَّ خطوة اختيار الصفحات.',
  business_pages:
    'حسابك يستخدم Meta Business Suite. أثناء التفويض وافق على صلاحية إدارة الأعمال واختر النشاط والصفحة المرتبطة بإنستغرام ثم أعد المحاولة.',
  oauth_failed:
