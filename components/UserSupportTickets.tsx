...
} from '../utils/supportTicketStyles';
...
const UserSupportTickets: React.FC = () => {
  ...
  const getStatusColor = (status: string) => supportTicketStatusColor(status);
  ...
  const getStatusLabel = (status: string) => supportTicketStatusLabel(status);

  const getPriorityColor = (priority: string) => supportTicketPriorityColor(priority);

  const getPriorityLabel = (priority: string) => supportTicketPriorityLabel(priority);
