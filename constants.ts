...
export const SAAS_MARKETING_DATA = {
  ...
  main_value: "بوت مبيعات ذكي عربي يرد على عملائك ويبيع عنك على فيسبوك وإنستغرام وتيليجرام — من التعليق إلى الطلب في لوحة واحدة.",
  pricing_notes: "نقدم تجربة مجانية لمدة 7 أيام. الباقات: التعليقات (5$)، القناة الواحدة (21$)، السوشيال (35$)، والسنوية (200$).",
  features: [
    "بوت مبيعات على ماسنجر فيسبوك، إنستغرام، وتيليجرام",
...
export const SAAS_SUPPORT_DATA = {
  tutorials: {
    ...
    connect_channel: [
      ...
      "اختر القناة: فيسبوك أو إنستغرام أو تيليجرام.",
